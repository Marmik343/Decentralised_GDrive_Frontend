...
function App() {
  ...
  useEffect(() => {
    ...
    const loadProvider = async() => {
      if(provider){
        ...
        //Metamask script to detect account change
  ...
  }, []); //Add this empty array, so that the rendering happens only once.
  ...
  return (
    ...
    <div className="App">
      ...
      <p> Account : {account ? account : 'Please connect to Metamask'} </p>
